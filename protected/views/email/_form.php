...
$model2=Countries::model()->findAll();

$list=CHtml::listData($model2,'country_id','country_name');
...
<div class="row-fluid">
	...
	<div class="row span4">
		...
		<?php echo $form->DropDownList($model,'user_type',array('empty'=>Null,'Author'=>'Author'),array('style'=>'padding:5px;font-size:14px;','class'=>'span12')); ?>
...
<div class="row-fluid">   
	...
	<div class="row span4">
		...
		<?php echo $form->DropDownList($model,'country',$list,array('class'=>'span12')); ?>
