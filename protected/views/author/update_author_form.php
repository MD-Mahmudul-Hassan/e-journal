...
<!--	<p class="note">Fields with <span class="required">*</span> are required.</p>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'author_first_name',array('size'=>60,'maxlength'=>100,'style'=>'width:300px;')); ?>
		<?php echo $form->error($model,'author_first_name'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'author_last_name'); ?>
		<?php echo $form->textField($model,'author_last_name',array('size'=>60,'maxlength'=>100,'style'=>'width:300px;')); ?>
