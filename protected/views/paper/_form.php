...
<div class="row-fluid">
    ...
    <!--	<div class="row">
            ...
            <div class="row">
                    ...
                    <?php echo $form->textField($model,'paper_title',array('size'=>60,'maxlength'=>200,'class'=>'span5 tooltipster','title'=>'Title of your paper. This title will remain unchanged during the entire reviewing process.')); ?>
                    <?php echo $form->error($model,'paper_title'); ?>
            </div>

            <div class="row">
                    <?php echo $form->labelEx($model,'paper_field'); ?>
                    <?php echo $form->DropDownList($model,'paper_field',$paper_fields,array('class'=>'span5 tooltipster','title'=>'Select your research field from the list')); ?>
                    <?php echo $form->error($model,'paper_field'); ?>
            </div>

            <div class="row">
                    <?php echo $form->labelEx($model,'paper_subject'); ?>
                    <?php echo $form->textField($model,'paper_subject',array('size'=>60,'maxlength'=>100,'class'=>'span5 tooltipster','title'=>'Write the subject name of your research paper')); ?>
