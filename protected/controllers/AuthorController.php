                                    ...
                                    {    
                                        ...
                                        $this->check_equality_of_both_file_names($filename, $filename2);
                                            ...
                                            if($database_updating_result_for_final_copy==='success')
                                            {
                                               ...
                                               $model->paper_file->saveAs(Yii::app()->basePath.'/accepted_papers/ty#@kio12e2qz34%!@216splk53sS13TY2#Weytu23jEC@tp37610@%aR!#lZopPMao[]/j#1%!23JqZdru%@_3349kp_%E43#@!srY97#@!DFG_#@ZP@GL#3@8eP21/accepted_doc_or_docx_papers/'.$filename);
                                               $model->paper_file->saveAs(Yii::app()->basePath.'/accepted_papers/ty#@kio12e2qz34%!@216splk53sS13TY2#Weytu23jEC@tp37610@%aR!#lZopPMao[]/j#1%!23JqZdru%@_3349kp_%E43#@!srY97#@!DFG_#@ZP@GL#3@8eP21/accepted_pdf_versions/'.$filename2);
