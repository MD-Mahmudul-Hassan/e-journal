...
class BlogadminController extends Controller
{
	...
	{
		$model=new Model_blog('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Model_blog']))
			$model->attributes=$_GET['Model_blog'];
	 ...
	 * @return Model_blog the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Model_blog::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Model_blog $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='model-blog-form')
		{
